...
<?php
	...
	$queryemp = $nq->getEmpInfoByRecord1($rec);
	while($rr = mysql_fetch_array($queryemp))
	{		
		$epas = $nq->getEpasCode($rr['record_no'],$emp);
	  ...
	  ?>     	
      	...
      	<table class="table table-bordered">
            ...
            <tr>
                ...
                <td><i><b><?php echo $rr['pos_desc'];?></b></i></td>
				<td>EOC Date</td>
...
function viewepas(rec,emp){
	window.open("epasview.php?table=employmentrecord_&rec="+rec+"&empid="+emp,'_blank');
}
